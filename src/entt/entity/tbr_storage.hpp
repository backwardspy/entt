#ifndef ENTT_ENTITY_TBR_STORAGE_HPP
#define ENTT_ENTITY_TBR_STORAGE_HPP
...
class tbr_basic_storage: public tbr_basic_sparse_set<Entity> {
    ...
    using underlying_type = tbr_basic_sparse_set<Entity>;
    using traits_type = entt_traits<Entity>;

    template<bool Const>
    class storage_iterator final {
        friend class tbr_basic_storage<Entity, Type>;
...
/*! @copydoc tbr_basic_storage */
template<typename Entity, typename Type>
class tbr_basic_storage<Entity, Type, std::enable_if_t<is_empty_v<Type>>>: public tbr_basic_sparse_set<Entity> {
    using underlying_type = tbr_basic_sparse_set<Entity>;
