...
#include <entt/entity/tbr_sparse_set.hpp>
...
TEST(SparseSet, Functionalities) {
    ...
    entt::tbr_sparse_set other{std::move(set)};
...
TEST(SparseSet, Iterator) {
    using iterator = typename entt::tbr_sparse_set::iterator;
...
TEST(SparseSet, ReverseIterator) {
    using reverse_iterator = typename entt::tbr_sparse_set::reverse_iterator;
...
TEST(SparseSet, RespectDisjoint) {
    entt::tbr_sparse_set lhs;
    entt::tbr_sparse_set rhs;
